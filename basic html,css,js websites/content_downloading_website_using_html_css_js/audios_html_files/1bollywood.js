...
songs=[
    {song_name:"Bhula Dena Aashiqui 2",artist_name:"Uknown Artist",audio_path:"../audios/bollywood/1.mp3"},
    {song_name:"Arijit Singh Pachtaoge Vicky_Kaushal,",artist_name:"Uknown Artist",audio_path:"../audios/bollywood/2.mp3"},
    {song_name:"Awaaz Qismat",artist_name:"AmmyVirk",audio_path:"../audios/bollywood/3.mp3"},
    {song_name:"Bekhayali",artist_name:"Uknown Artist",audio_path:"../audios/bollywood/4.mp3"},
    {song_name:"Dil Diyan Gallan",artist_name:"Uknown Artist",audio_path:"../audios/bollywood/5.mp3"},
    {song_name:"Hamdard",artist_name:"Uknown Artist",audio_path:"../audios/bollywood/6.mp3"},
    {song_name:"Hawayein",artist_name:"Uknown Artist",audio_path:"../audios/bollywood/7.mp3"},
    {song_name:"Kalank",artist_name:"Uknown Artist",audio_path:"../audios/bollywood/8.mp3"},
    {song_name:"KAUN TUJHE",artist_name:"Uknown Artist",audio_path:"../audios/bollywood/9.mp3"},
    {song_name:"Kesari",artist_name:"Uknown Artist",audio_path:"../audios/bollywood/10.mp3"},
    {song_name:"Lehanga",artist_name:"Uknown Artist",audio_path:"../audios/bollywood/11.mp3"},
    {song_name:"Ik Tera",artist_name:"Maninder Buttar",audio_path:"../audios/bollywood/12.mp3"},
    {song_name:"Phir Bhi Tumko",artist_name:"Uknown Artist",audio_path:"../audios/bollywood/13.mp3"},
    {song_name:"Raabta",artist_name:"Uknown Artist",audio_path:"../audios/bollywood/14.mp3"},
    {song_name:"Shayad Love Aaj Kal",artist_name:"Uknown Artist",audio_path:"../audios/bollywood/15.mp3"},
    {song_name:"Soch Na Sake",artist_name:"Uknown Artist",audio_path:"../audios/bollywood/16.mp3"},
    {song_name:"Teri Mitti Kesari",artist_name:"Uknown Artist",audio_path:"../audios/bollywood/17.mp3"},
    {song_name:"Zaroorat",artist_name:"Uknown Artist",audio_path:"../audios/bollywood/18.mp3"},
]
...
Array.from(document.getElementsByClassName("song_item_play"),(element)=>{
    ...
    audioElement.src=`../audios/bollywood/${songIndex+1}.mp3`;
